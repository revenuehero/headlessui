...
function _render(props, slot = {}, tag, name) {
  ...
  if (Component === import_react14.Fragment) {
    if (Object.keys(compact(rest)).length > 0) {
      ...
      let newClassName = typeof (childProps == null ? void 0 : childProps.className) === "function" ? (
        // @ts-expect-error
        (...args) => classNames(childProps == null ? void 0 : childProps.className(...args), rest.className)
      ) : classNames(childProps == null ? void 0 : childProps.className, rest.className);
...
// src/components/portal/portal.tsx
var RHPortalRootContext = (0, import_react27.createContext)(null);
function RHPortalRoot(props) {
  return /* @__PURE__ */ import_react27.default.createElement(RHPortalRootContext.Provider, { value: props.root }, props.children);
}
function useRHPortalRootContext() {
  try {
    return (0, import_react27.useContext)(RHPortalRootContext);
  } catch (error) {
    return null;
  }
}
function usePortalTarget(ref) {
  ...
  let [target, setTarget] = (0, import_react27.useState)(() => {
    ...
    if (env.isServer)
      return null;
    const portalInjectTarget = rhPortalRoot || (ownerDocument == null ? void 0 : ownerDocument.body) || null;
    let existingRoot = portalInjectTarget == null ? void 0 : portalInjectTarget.querySelector("#headlessui-portal-root");
    if (existingRoot)
      return existingRoot;
    if (ownerDocument === null || portalInjectTarget === null)
      return null;
  ...
  (0, import_react27.useEffect)(() => {
    if (target === null)
      return;
    const portalInjectTarget = rhPortalRoot || (ownerDocument == null ? void 0 : ownerDocument.body);
    if (!(portalInjectTarget == null ? void 0 : portalInjectTarget.contains(target))) {
      portalInjectTarget == null ? void 0 : portalInjectTarget.appendChild(target);
    }
